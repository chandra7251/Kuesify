...
<template>
    <div class="min-h-screen bg-[#f4fbfa] text-slate-900">
        <header
            class="sticky top-0 z-30 border-b border-teal-100 bg-white/95 backdrop-blur"
        >
            <div
        ...
        <header v-if="$slots.header" class="border-b border-teal-100 bg-white">
        ...
        >
            <Link
                ...
                :class="{
                    'bg-teal-700 text-white': $page.url.startsWith(item.href),
                }"
                ><svg
                    class="h-5 w-5"
                    viewBox="0 0 24 24"
