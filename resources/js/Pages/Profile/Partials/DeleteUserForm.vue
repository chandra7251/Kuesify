    ...
    <section class="space-y-6">
        <header>
            ...
            <p class="mt-1 text-sm text-gray-600">
                Setelah akun dihapus, seluruh data dan sumber daya akan dihapus
                secara permanen. Unduh data yang masih ingin Anda simpan.
            </p>
        </header>
        ...
        <Modal :show="confirmingUserDeletion" @close="closeModal">
            <div class="p-6">
                ...
                <p class="mt-1 text-sm text-gray-600">
                    Setelah akun dihapus, seluruh data dan sumber daya akan
